...
public class DetailKategori extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //txt_id.setText("Tes id");

        Intent intent = getIntent();
        id_kategori_ambil = intent.getStringExtra("id_kategori");
        //Toast.makeText(this,""+id_kategori_ambil,Toast.LENGTH_SHORT).show();
        getEmployee();
        getEmployee();
        getEmployee();
    ...
    private void getEmployee(){
        class GetEmployee extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                ...
                //Toast.makeText(DetailKategori.this,""+s,Toast.LENGTH_SHORT).show();
                return s;
            }
        }
    ...
    private void updateEmployee(final String nama){
        class UpdateEmployee extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... params) {
                HashMap<String,String> hashMap = new HashMap<>();
                hashMap.put(Konfigurasi.KEY_EMP_ID_KATEGORI,id_kategori_ambil);
                hashMap.put(Konfigurasi.TAG_NAMA,nama);
